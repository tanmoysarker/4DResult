...
export class MPT extends Component {
  ...
  async componentDidMount() {
    ...
    if ((time >= 20) && (time <= 21 ) && (today.getMinutes()<=30)){
      this.setState({ 
        tableData: [],
        tableData1: [],
        tableData2: [],
    ...
    await fetch('https://vip4dresult.azurewebsites.net/nine932/'+year+month+day, {
      ...
      if ((time >= 19) && (time <= 20 ) && (today.getMinutes()<=30)){
        this.setState({ 
          tableData5: [],
          tableData6: [],
          tableData7: [],
          ...
          <View>
              <Card style={{ backgroundColor: '#f6eb13', height: 200, width: 115, paddingTop: 10, alignItems: 'center' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                  {(this.state.live) ? <Icon name='football' style={{color: '#000', fontSize: 24, marginTop: 15 }}/>: <Icon name='refresh' style={{color: '#000', fontSize: 24, marginTop: 15 }}  />}
                </View>
              </Card>
              ...
              <View style={styles.container}>
                <Table style={{ flexDirection: 'row' }} borderStyle={{ borderWidth: 4, borderColor: '#c5cbd6' }}>
                  <TableWrapper style={{ width: 115 }}>
                    <Cell data={(this.state.toggle) === 0 ? "Consolation" : (this.state.toggle) === 1 ? "安慰獎": "Saguhati"} style={{ width: 115, height: 40, backgroundColor: '#f6eb13' }} textStyle={{ color: '#000', margin: 6, alignSelf: 'center',fontSize:16,fontWeight:'bold' }} />
                    <TableWrapper style={{ flexDirection: 'row',height:550 }}>
            ...
            <View>
              <Card style={{ backgroundColor: 'red', height: 200, width: 115, paddingTop: 10, alignItems: 'center' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                {(this.state.live) ? <Icon name='football' style={{color: '#fff', fontSize: 24, marginTop: 15 }}/>: <Icon name='refresh' style={{color: '#fff', fontSize: 24, marginTop: 15 }}  />}
                </View>
              </Card>
              ...
              <View style={styles.container}>
                <Table style={{ flexDirection: 'row' }} borderStyle={{ borderWidth: 4, borderColor: '#c5cbd6' }}>
                  <TableWrapper style={{ width: 115 }}>
                    <Cell data={(this.state.toggle) === 0 ? "Consolation" : (this.state.toggle) === 1 ? "安慰獎": "Saguhati"} style={{ width: 115, height: 40, backgroundColor: 'red' }} textStyle={{ color: '#fff', margin: 6, alignSelf: 'center',fontSize:16,fontWeight:'bold' }} />
                    <TableWrapper style={{ flexDirection: 'row',height:550 }}>
              ...
              <View style={styles.container}>
                <Table style={{ flexDirection: 'row' }} borderStyle={{ borderWidth: 4, borderColor: '#c5cbd6' }}>
                  <TableWrapper style={{ width: 115 }}>
                    <Cell data={(this.state.toggle) === 0 ? "Consolation" : (this.state.toggle) === 1 ? "安慰獎": "Saguhati"} style={{ width: 115, height: 40, backgroundColor: 'red' }} textStyle={{ color: '#fff', margin: 6, alignSelf: 'center',fontWeight:'bold' }} />
                    <TableWrapper style={{ flexDirection: 'row' }}>
