      ...
      <Container style={{ backgroundColor: '#fff' }}>
        <Content>
          ...
          <View style={{ paddingVertical: 20 }}>
            <Button style={{ width: '100%', backgroundColor: '#CFD7DC', alignItems: 'center', justifyContent: 'center' }}><Text style={{ fontSize: 20, fontWeight: "bold", color: '#000' }}>{(this.state.toggle) === 0 ? "Share" : (this.state.toggle) === 1 ? "分享" : "Kongsi"}</Text></Button>
          </View>
        </Content>
      </Container>
    );
