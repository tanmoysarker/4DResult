      ...
      <Container style={{ backgroundColor: '#fff' }}>
        <Content>
          <View>
            <Card style={{ backgroundColor: '#CFD7DC', height: 100, paddingTop: 10 }}>
              <View style={{ flexDirection: 'row', paddingHorizontal: 10 }}>
                ...
                <Body><Text style={{ color: '#000', fontSize: 20, fontWeight: "bold" }}>{this.state.toggle ? "多多" : "Toto"}</Text></Body>
          ...
          <View style={{ paddingVertical: 20 }}>
            <Button style={{ width: '100%', backgroundColor: '#CFD7DC', alignItems: 'center', justifyContent: 'center' }}><Text style={{ fontSize: 20, fontWeight: "bold", color: '#000' }}>{this.state.toggle ? "分享" : "Share"}</Text></Button>
          </View>
        </Content>
      </Container>
    );
